...
#
# for only 2016 docs
# python newDocsModel.py TrumpTexts 1 signalOutput-coco_3_cv_3_netAng_30_twc_20_tfidfNoPro_pronounFrac_bin_10-7B7C2E.csv auto
#
# for even distribution of new and old groups 
# python newDocsModel.py TrumpTexts 1 signalOutput-coco_3_cv_3_netAng_30_twc_20_tfidfNoPro_pronounFrac_bin_10-2BRVHT.csv auto
# OR
# python newDocsModel.py TrumpTexts 1 signalOutput-coco_3_cv_3_netAng_30_twc_20_tfidfNoPro_pronounFrac_bin_10-Z10HBZ.csv auto
#
# 
#########
...
def textAnalysis(paramList):
    ...
    try:
        ...
        return(['_'.join(groupId)]+[len(subFileList)]+[None] * 17)
